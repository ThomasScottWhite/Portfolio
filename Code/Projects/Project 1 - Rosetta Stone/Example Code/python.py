...
def main():
    #Variables
        ...
        #arrays
        list = [[1,2],2,3,4]
        #The following is technically a multiline string but can be used as multiline comment
        """
...
# If statements
    #If statements can use ==,!=,<,<=,>=,>=,and,or,etc
if True == True:
    pass
elif False != True:
    pass
...
class TheirClass(MyClass):
  def __init__(self, fname, lname): # recreating functions overrides parent's methods
    MyClass.__init__(self, fname, lname) # you can recall parent functions like this
